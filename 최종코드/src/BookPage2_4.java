...
public class BookPage2_4 extends JFrame {
	public static JPanel contentPane;
	JButton m4_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
	
	public BookPage2_4(String tfID, String title) {
		List l1 =new List();
		...
		//create text field
				...
				m4_bt = new JButton();
				m4_bt.setBounds(130, 230, 170,200);
				ImageIcon icon = new ImageIcon("건축학개론.jpg");
				m4_bt.setIcon(icon);
