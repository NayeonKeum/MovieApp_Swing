...
public class BookPage2_9 extends JFrame {
	public static JPanel contentPane;
	JButton m9_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
		
	public BookPage2_9(String tfID, String title) {
		List l1 =new List();
		...
		JLabel lb_m9 = new JLabel("아가씨");
		lb_m9.setFont(font);
		lb_m9.setBounds(130, 120, 100, 50);
		lb_m9.setForeground(new Color(18, 50, 181));
		contentPane.add(lb_m9);
		
		m9_bt = new JButton();
		m9_bt.setBounds(130, 170, 170,200);
		ImageIcon icon = new ImageIcon("아가씨.jpeg");
		m9_bt.setIcon(icon);
