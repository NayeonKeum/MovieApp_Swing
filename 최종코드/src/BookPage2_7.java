...
public class BookPage2_7 extends JFrame {
	public static JPanel contentPane;
	JButton m7_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
		
	public BookPage2_7(String tfID, String title) {
		List l1 =new List();
		...
		label.setFont(font2);
		label.setBounds(300, 72, 1001, 80);
		label.setForeground(new Color(18, 50, 181));
		contentPane.add(label);

		JLabel lb_m7 = new JLabel("트와일라잇");
		lb_m7.setFont(font);
		lb_m7.setBounds(130, 180, 100, 50);
		lb_m7.setForeground(new Color(18, 50, 181));
		contentPane.add(lb_m7);
		
		m7_bt = new JButton();
		m7_bt.setBounds(130, 230, 170,200);
		ImageIcon icon = new ImageIcon("트와일라잇.jpeg");
		m7_bt.setIcon(icon);
