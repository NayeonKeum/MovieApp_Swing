...
public class BookPage2_6 extends JFrame {
	public static JPanel contentPane;
	JButton m6_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
		
	public BookPage2_6(String tfID, String title)  {
		List l1 =new List();
		...
		//create text field
				...
				JLabel lb_m1 = new JLabel("7번방의 선물");
				lb_m1.setFont(font);
				lb_m1.setBounds(130, 180, 170, 50);
				lb_m1.setForeground(new Color(18, 50, 181));
				contentPane.add(lb_m1);
				
				m6_bt = new JButton();
				m6_bt.setBounds(130, 230, 170,200);
				ImageIcon icon = new ImageIcon("7번방의 선물.jpg");
				m6_bt.setIcon(icon);
