...
class DatePicker 
{
	//define variables
        ...
        Font font = new Font("¿¤¸®½º µðÁöÅÐ¹è¿òÃ¼", Font.BOLD, 10);
        ...
        public DatePicker(JFrame parent)//create constructor 
        {
        	//create object
                ...
                {		
                	//define variable
                        ...
                        if (x < 7)//if loop condition 
                        {
                                ...
                                button[x].setForeground(new Color(18, 50, 181));
				...
				previous.setBackground(new Color(18, 50, 181));
                //add action command
				...
				next.setBackground(new Color(18, 50, 181));
                //add action command
                p2.add(next);
