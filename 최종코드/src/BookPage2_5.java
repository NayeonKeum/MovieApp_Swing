...
public class BookPage2_5 extends JFrame {
	public static JPanel contentPane;
	JButton m5_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
	
	public BookPage2_5(String tfID, String title) {
		List l1 =new List();
		...
		//create text field
				...
				m5_bt = new JButton();
				m5_bt.setBounds(130, 230, 170,200);
				ImageIcon icon = new ImageIcon("1987.jpg");
				m5_bt.setIcon(icon);
