...
public class BookPage2_8 extends JFrame {
	public static JPanel contentPane;
	JButton m8_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
		
	public BookPage2_8(String tfID, String title) {
		List l1 =new List();
		...
		//create text field
				...
				m8_bt = new JButton();
				m8_bt.setBounds(130, 230, 170,200);
				ImageIcon icon = new ImageIcon("아저씨.jpeg");
				m8_bt.setIcon(icon);
