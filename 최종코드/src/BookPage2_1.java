...
public class BookPage2_1 extends JFrame {
	public static JPanel contentPane;
	JButton m1_bt, nextbt, backbt;
...
//        }
	...
	public BookPage2_1(String tfID, String title) {
		List l1 =new List();
		//set title
		...
		m1_bt = new JButton();
		m1_bt.setBounds(130, 230, 170,200);
		ImageIcon icon = new ImageIcon("해리포터.jpg");
		m1_bt.setIcon(icon);
