...
public class BookPage2_3 extends JFrame {
	public static JPanel contentPane;
	JButton m3_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
	
	public BookPage2_3(String tfID, String title) {
		List l1 =new List();
		...
		//create text field
				...
				m3_bt = new JButton();
				m3_bt.setBounds(130, 230, 170,200);
				ImageIcon icon = new ImageIcon("극한직업.jpg");
				m3_bt.setIcon(icon);
