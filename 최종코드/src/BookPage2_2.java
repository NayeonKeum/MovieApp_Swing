...
public class BookPage2_2 extends JFrame {
	public static JPanel contentPane;
	JButton m2_bt, nextbt, backbt;
	String date=" ", time =" ", place=" ";
	private JTextField txtDate;
	
	public BookPage2_2(String tfID, String title) {
		List l1 =new List();
		...
		//create text field
				...
				JLabel lb_m1 = new JLabel("나의 소녀시대");
				lb_m1.setFont(font);
				...
				m2_bt = new JButton();
				m2_bt.setBounds(130, 230, 170,200);
				ImageIcon icon = new ImageIcon("나의 소녀시대.jpg");
				m2_bt.setIcon(icon);
